...
const Project = ({ type, title, summary, img, link, github }) => {
	return (
		<article className="w-full flex items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative flex-col dark:bg-dark dark:border-light xs:p-4">
...
function projects() {
	return (
		<>
			<Head>
				<title>Rashad | Projects Page</title>
				<meta name="description" content="Projects done by Rashad" />
			</Head>
			<TransitionEffect/>

	...
	return (
		<motion.div
			className="flex items-center justify-center rounded-full font-semibold
			 bg-dark py-3 px-6 shadow-dark text-light cursor-pointer absolute
...
function Skills() {
	return (
		<>
			...
			>
				<motion.div
					className="flex items-center justify-center rounded-full font-semibold bg-dark p-8 shadow-dark text-light cursor-pointer dark:text-dark dark:bg-light lg:p-6 md:p-4 xs:text-xs xs:p-2"
					whileHover={{ scale: 1.05 }}
				>
					Web
				</motion.div>
